          ...
          <div className="account-hub-content">
            ...
            <div className="grid-column">
              ...
              <p>
                ...
                service to see if you are using it. The Gravatar service privacy policy is available
                here: https://automattic.com/privacy/. After approval of your comment, your profile picture is visible to the
              ...
              <h5>4. Embedded content from other websites</h5>
              <p>
              ...
              <h5>5. How long we retain your data</h5>
              <p>
