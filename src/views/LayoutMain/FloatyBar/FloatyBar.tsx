          ...
          <div className="action-list dark" onClick={handleCloseMenu}>
            ...
            {user.verifiedAccount ? (
              <Link className="action-list-item" to="/user/create-post">
                <svg className="action-list-item-icon" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24">
                  <path
                    fill="#000000"
            ...
            <Link className="action-item-wrap" to="/user/messages">
              <div className="action-item">
                <svg className="action-list-item-icon" xmlns="http://www.w3.org/2000/svg" width="35" height="35" viewBox="0 0 24 24">
                  <path
                    fill="#000000"
