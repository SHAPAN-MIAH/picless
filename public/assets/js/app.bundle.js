...
----------------*/require("simplebar");/*-----------------
    PAGE LOADER 
-----------------*/var modules=[];modules.push({name:"page-loader",module:require("./global/page-loader")});/*---------------
    TOOLTIPS 
---------------*/modules.push({name:"tooltips",module:require("./global/tooltips")});/*---------------
    POPUPS 
---------------*/modules.push({name:"popups",module:require("./global/popups")});/*-----------------
    ACCORDIONS
-----------------*/modules.push({name:"accordions",module:require("./global/accordions")});/*------------
    UTILS 
------------*/require("./utils/svg-loader");// Not Needed
require("./utils/demo-icons");// modules.push({ name: "liquidify", module: require("./utils/liquidify") });
/*------------
    FORM 
------------*/modules.push({name:"form-rating",module:require("./form/form-rating")});modules.push({name:"form-counter",module:require("./form/form-counter")});modules.push({name:"form-switch",module:require("./form/form-switch")});modules.push({name:"form-input",module:require("./form/form-input")});modules.push({name:"interactive-input",module:require("./form/interactive-input")});/*--------------
    LANDING 
--------------*/modules.push({name:"landing-tabs",module:require("./landing/landing.tabs")});/*-------------
    HEADER 
-------------*/ // require("./header/header.progressBar"); // IF WE NEEDS TO USE -> Migrate to module
modules.push({name:"header-dropdown",module:require("./header/header.dropdown")});/*-------------
    SIDEBAR 
-------------*/modules.push({name:"sidebar",module:require("./sidebar/sidebar")});/*-----------------
    USER AVATAR 
-----------------*/modules.push({name:"user-avatar",module:require("./global/user-avatar.hexagons")});/*----------
    MAPS 
----------*/ // require("./global/maps");
/*---------------
    CONTENT 
---------------*/modules.push({name:"progressBar",module:require("./content/content.progressBar")});modules.push({name:"slider",module:require("./content/content.slider")});modules.push({name:"dropdown",module:require("./content/content.dropdown")});modules.push({name:"content-tab",module:require("./content/content.tab")});/*-------------
    CHARTS
-------------*/modules.push({name:"charts",module:require("./global/charts")});// /*---------------
//     WIDGETS
// ---------------*/
// require("./widget/twitter");
function load(moduleNames){if(Array.isArray(moduleNames)){modules.forEach(function(m){moduleNames.forEach(function(n){if(m.name===n){m.module.load();}});});}else{modules.forEach(function(m){m.module.load();});}}window.tpl={load:load};

},{"./content/content.dropdown":49,"./content/content.progressBar":50,"./content/content.slider":51,"./content/content.tab":52,"./form/form-counter":53,"./form/form-input":54,"./form/form-rating":55,"./form/form-switch":56,"./form/interactive-input":57,"./global/accordions":58,"./global/charts":59,"./global/page-loader":60,"./global/popups":61,"./global/tooltips":62,"./global/user-avatar.hexagons":63,"./header/header.dropdown":64,"./landing/landing.tabs":65,"./sidebar/sidebar":66,"./utils/demo-icons":68,"./utils/svg-loader":70,"simplebar":3}],49:[function(require,module,exports){
"use strict";var plugins=require("../utils/plugins");function load(){// console.info("content.dropdown");
plugins.createDropdown({trigger:".widget-box-post-settings-dropdown-trigger",container:".widget-box-post-settings-dropdown",offset:{top:30,right:9},animation:{type:"translate-top",speed:0.3,translateOffset:{vertical:20}}});plugins.createDropdown({trigger:".reaction-item-dropdown-trigger",container:".reaction-item-dropdown",triggerEvent:"hover",offset:{bottom:38,left:-16},animation:{type:"translate-bottom",speed:0.3,translateOffset:{vertical:20}}});plugins.createDropdown({trigger:".reaction-options-dropdown-trigger",container:".reaction-options-dropdown",triggerEvent:"click",offset:{bottom:54,left:-16},animation:{type:"translate-bottom",speed:0.3,translateOffset:{vertical:20}},closeOnDropdownClick:true});plugins.createDropdown({trigger:".reaction-options-small-dropdown-trigger",container:".reaction-options-small-dropdown",triggerEvent:"click",offset:{bottom:30,left:-80},animation:{type:"translate-bottom",speed:0.3,translateOffset:{vertical:16}},closeOnDropdownClick:true});plugins.createDropdown({trigger:".post-settings-dropdown-trigger",container:".post-settings-dropdown",offset:{bottom:30,right:0},animation:{type:"translate-bottom",speed:0.3,translateOffset:{vertical:16}}});}module.exports={load:load};

},{"../utils/plugins":69}],50:[function(require,module,exports){
"use strict";var plugins=require("../utils/plugins");function load(){// console.info("content.progressbar");
/*-----------------------
    EXP TO NEXT LEVEL
...
---------------------*/plugins.createProgressBar({container:"#post-engagement-1",height:4,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#post-engagement-1",height:4,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:100,stop:89},linkText:true,linkUnits:"%",animateOnScroll:true});plugins.createProgressBar({container:"#post-engagement-2",height:4,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#post-engagement-2",height:4,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:100,stop:74},linkText:true,linkUnits:"%",animateOnScroll:true});plugins.createProgressBar({container:"#post-engagement-3",height:4,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#post-engagement-3",height:4,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:100,stop:53},linkText:true,linkUnits:"%",animateOnScroll:true});plugins.createProgressBar({container:"#post-engagement-4",height:4,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#post-engagement-4",height:4,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:100,stop:48},linkText:true,linkUnits:"%",animateOnScroll:true});plugins.createProgressBar({container:"#post-engagement-5",height:4,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#post-engagement-5",height:4,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:100,stop:21},linkText:true,linkUnits:"%",animateOnScroll:true});/*-----------------
    TOP COUNTRY
-----------------*/plugins.createProgressBar({container:"#top-country-1",width:178,height:6,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#top-country-1",width:178,height:6,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:25362,stop:25362},split:{parts:30,gap:2,color:"#fff"},linkText:true,linkUnits:false,animateOnScroll:true});plugins.createProgressBar({container:"#top-country-2",width:178,height:6,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#top-country-2",width:178,height:6,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:25362,stop:18201},split:{parts:30,gap:2,color:"#fff"},linkText:true,linkUnits:false,animateOnScroll:true});plugins.createProgressBar({container:"#top-country-3",width:178,height:6,lineColor:"#e7e8ee"});plugins.createProgressBar({container:"#top-country-3",width:178,height:6,gradient:{colors:["#615dfa","#41efff"]},scale:{start:0,end:25362,stop:9567},split:{parts:30,gap:2,color:"#fff"},linkText:true,linkUnits:false,animateOnScroll:true});}module.exports={load:load};

},{"../utils/plugins":69}],51:[function(require,module,exports){
"use strict";var plugins=require("../utils/plugins");function load(){console.info("content.slider");/*---------------------
  PROFILE HEADER 
  ---------------------*/plugins.createSlider({container:"#profile-header-social-links-slider",items:5,fixedWidth:32,gutter:8,loop:false,nav:false,controlsContainer:"#profile-header-social-links-slider-controls",responsive:{481:{fixedWidth:40,gutter:12}}});/*-------------------------
  SECTION NAVIGATION - TABS IN USER PROFILE
  -------------------------*/plugins.createSlider({container:"#section-navigation-slider",items:4,nav:false,loop:false,controlsContainer:"#section-navigation-slider-controls"});/*-------------------------
  SECTION NAVIGATION
  -------------------------*/plugins.createSlider({container:"#section-navigation-medium-slider",items:5,fixedWidth:160,nav:false,loop:false,controlsContainer:"#section-navigation-medium-slider-controls"});/*------------------------
  USER STATS SLIDER
...
},{"../utils/core":67}],58:[function(require,module,exports){
"use strict";var plugins=require("../utils/plugins");function load(){console.info("accordions");plugins.createAccordion({triggerSelector:".accordion-trigger",contentSelector:".accordion-content",startOpenClass:"accordion-open",selectedClass:"selected",linkTriggers:false});plugins.createAccordion({triggerSelector:".accordion-trigger-linked",contentSelector:".accordion-content-linked",startOpenClass:"accordion-open",selectedClass:"selected",linkTriggers:true});}module.exports={load:load};

},{"../utils/plugins":69}],59:[function(require,module,exports){
"use strict";var plugins=require("../utils/plugins"),app=require("../utils/core");var getLabelNumbers=function getLabelNumbers(count){var labels=[];for(var i=1;i<=count;i++){var label=i<10?"0".concat(i):i.toString();labels.push(label);}return labels;};var getCompleterData=function getCompleterData(datasetsData,maxValue){var completerData=new Array(datasetsData[0].length).fill(maxValue);for(var i=0;i<datasetsData.length;i++){for(var j=0;j<datasetsData[i].length;j++){completerData[j]-=datasetsData[i][j];}}return completerData;};function load(){console.info("global.charts");/*------------------------
    ENGAGEMENTS CHART
...
if(e.keyCode===27){headerSearchDropdown.hideDropdowns();previousValue="";window.removeEventListener("keydown",hideSearchDropdownOnKey);}};var toggleSearchDropdown=function toggleSearchDropdown(e){if(previousValue===""&&e.target.value!==""){headerSearchDropdown.showDropdowns();window.addEventListener("keydown",hideSearchDropdownOnKey);}else if(e.target.value===""){headerSearchDropdown.hideDropdowns();window.removeEventListener("keydown",hideSearchDropdownOnKey);}previousValue=e.target.value;};var interactiveInputAction=searchInput.parentElement.querySelector(".interactive-input-action");var hideSearchDropdown=function hideSearchDropdown(){headerSearchDropdown.hideDropdowns();window.removeEventListener("keydown",hideSearchDropdownOnKey);previousValue="";};if(window.innerWidth>breakpointWidth){searchInput.addEventListener("input",toggleSearchDropdown);interactiveInputAction.addEventListener("click",hideSearchDropdown);}});/*----------------------
    HEADER DROPDOWNS
----------------------*/plugins.createDropdown({trigger:".header-dropdown-trigger",container:".header-dropdown",offset:{top:64,right:6},animation:{type:"translate-top"}});plugins.createDropdown({trigger:".header-settings-dropdown-trigger",container:".header-settings-dropdown",offset:{top:64,right:22},animation:{type:"translate-top"}});}module.exports={load:load};

},{"../utils/core":67,"../utils/plugins":69}],65:[function(require,module,exports){
"use strict";var plugins=require("../utils/plugins");function load(){plugins.createTab({triggers:".login-register-form-trigger",elements:".login-register-form-element",animation:{type:"slide-in-right"},onTabChange:function onTabChange(activeTab){var firstInput=activeTab.querySelector("input");firstInput.focus();}});}module.exports={load:load};

},{"../utils/plugins":69}],66:[function(require,module,exports){
"use strict";var app=require("../utils/core");function load(){// console.info("sidebar");
// /*-------------------
// CONTENT GRID
// -------------------*/
...
//           window.innerHeight - chatWidgetButton.offsetHeight - topOffset
//         }px`;
//       } else {
//         chatWidgetMessages.style.height = `${
//           window.innerHeight -
...
//     overlay.setAttribute("id", "overlay-mobile-menu");
...
},{"../utils/core":67}],67:[function(require,module,exports){
...
},{"./core":67}],69:[function(require,module,exports){
...
},{"chart.js":1,"tiny-slider/src/tiny-slider":47}],70:[function(require,module,exports){
