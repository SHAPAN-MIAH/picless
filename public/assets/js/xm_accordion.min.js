      ...
      try {
        for (var r, i = t[Symbol.iterator](); !(n = (r = i.next()).done); n = !0) {
          ...
          if (!c && !(c = a.parentElement.querySelector(s.contentSelector)))
            throw new Error(
              "Couldn't find ".concat(s.contentSelector, ' in ').concat(s.triggerSelector, " nor as it's sibling")
            )
          if (s.paddingAnimation)
            ...
            c.parentElement.appendChild(l),
              l.appendChild(c),
              d.accordions.push({ trigger: a, content: l, open: !0, startOpen: c.classList.contains(s.startOpenClass) })
          }
        }
      } catch (t) {
        ;(e = !0), (o = t)
      ...
      for (var r in e)
        'object' !== _typeof(e[r]) || e[r] instanceof Date
          ? e[r] instanceof Date
            ...
            : (n[r] = e[r])
          : ((o = e[r] instanceof Array ? [] : {}), void 0 === n[r] && (n[r] = o), t(n[r], e[r]))
    })(s, t),
    e(),
    o(),
    r(),
